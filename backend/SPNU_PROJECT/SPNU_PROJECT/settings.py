"""
Django settings for SPNU_PROJECT project.
...
SECRET_KEY = '#=)ei*rl+&l33%8h-uoj70df&l(*&be3c-qq&91j41%^z)$oy&'
...
ROOT_URLCONF = 'SPNU_PROJECT.urls'
...
WSGI_APPLICATION = 'SPNU_PROJECT.wsgi.application'
